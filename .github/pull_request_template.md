...
Describe the user-facing change and the affected areas.

## Validation

- [ ] `npm test`
- [ ] Any additional targeted checks
...
- [ ] HTML output changes still follow WCAG 2.2 AA expectations
- [ ] External or user-controlled content remains escaped where rendered
