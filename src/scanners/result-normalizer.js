...
export function normalizeUrlScanResult({
  ...
  return {
    ...
    page_load_count_daily: urlRecord.page_load_count_daily ?? null,
    page_load_count_rolling_7d: urlRecord.page_load_count_rolling_7d ?? null,
    page_load_count_rolling_30d: urlRecord.page_load_count_rolling_30d ?? null,
    page_load_by_window: urlRecord.page_load_by_window ?? null,
