...
# U.S. Government Website Accessibility Report: June 1, 2026

*Washington, D.C. -- June 1, 2026* -- A daily scan of 82 of the most-visited U.S. government websites found 176 accessibility barriers across 100 URLs today. The most common issues include Digital Motor Access, Visual Information Access, and Document Structure Navigation.
...
|-----------------|---------------------|--------------------------|
| Limited Manipulation | 22,948,016 | ~527,804 |
| Limited Reach and Strength | 8,308,669 | ~481,903 |
| Without Perception of Color | 8,376,213 | ~360,177 |
| Limited Vision | 11,564,073 | ~265,974 |
| Without Vision | 23,268,636 | ~232,686 |
| Limited Language, Cognitive, and Learning Abilities | 1,434,377 | ~70,284 |
| Without Hearing | 23,268,636 | ~69,806 |

*Total page loads across all scanned URLs today: 33,845,474*
...
Aggregate Lighthouse scores across 82 scanned U.S. government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 92.16 |
| Performance | 57.35 |
| Best Practices | 84.71 |
| SEO | 90.1 |
...
- [View full interactive report](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-06-01/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-06-01/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-06-01/axe-findings.csv)

---

*Generated by [Daily DAP](https://github.com/mgifford/daily-dap) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-06-01*
