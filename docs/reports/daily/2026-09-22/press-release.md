...
# U.S. Government Website Accessibility Report: September 22, 2026

*Washington, D.C. -- September 22, 2026* -- A daily scan of 96 of the most-visited U.S. government websites found 221 accessibility barriers across 100 URLs today. The most common issues include Digital Motor Access, Document Structure Navigation, and Primary Content Identification.
...
|-----------------|---------------------|--------------------------|
| Limited Reach and Strength | 16,026,501 | ~929,537 |
| Limited Manipulation | 24,939,832 | ~573,616 |
| Without Perception of Color | 9,232,288 | ~396,988 |
| Limited Vision | 12,350,978 | ~284,072 |
| Without Vision | 23,938,058 | ~239,381 |
| Limited Language, Cognitive, and Learning Abilities | 4,556,134 | ~223,251 |
| Without Hearing | 23,938,058 | ~71,814 |

*Total page loads across all scanned URLs today: 41,260,053*
...
*Found on 37 government websites today*
...
Aggregate Lighthouse scores across 96 scanned U.S. government websites today:

| Metric | Score |
|--------|-------|
| Accessibility | 91.53 |
| Performance | 47.82 |
| Best Practices | 86.04 |
| SEO | 89.06 |
...
- [View full interactive report](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-09-22/index.html)
- [Download accessibility findings (JSON)](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-09-22/axe-findings.json)
- [Download accessibility findings (CSV)](https://mgifford.github.io/daily-dap/docs/reports/daily/2026-09-22/axe-findings.csv)

---

*Generated by [Daily DAP](https://github.com/mgifford/daily-dap) | Source: Digital Analytics Program | Methodology: Lighthouse + axe-core | Date: 2026-09-22*
